...
const InvoicePreview = ({ invoiceData, onEdit }) => {
  ...
  const downloadInvoice = async () => {
    ...
    if (downloadBtn) downloadBtn.style.display = "none"; // Hide button before capture
    if (editBtn) editBtn.style.display = "none"; // Hide button before capture
    ...
    if (downloadBtn) downloadBtn.style.display = "block"; // Show button again
    if (editBtn) editBtn.style.display = "block";
  };

  return (
    <div ref={invoiceRef} className="max-w-4xl mx-auto my-10 bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
      {/* Header */}
      ...
      <div className="grid grid-cols-2 gap-6 p-6">
        ...
        <div>
          ...
          <p className="text-gray-600">
            {invoiceData?.customerEmail || "customer@example.com"}
          </p>
          <p className="text-gray-600">
            {invoiceData?.customerPhone || "+987 654 3210"}
          </p>
        </div>
      </div>
