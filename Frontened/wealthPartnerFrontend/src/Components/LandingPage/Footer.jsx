...
export default function Footer() {
  return (
    <section id="contacts" class="footer h-auto sm:pt-16 lg:pt-24 mt-10">
      <div class="px-4 mx-auto  sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <div className="flex flex-row gap-3 items-center">
              <img class="w-auto h-9" src="../../../public/favicon.png" />{" "}
              <h2 className="text-2xl font-bold">Wealth Partner</h2>
            </div>

            <p class="text-base leading-relaxed text-gray-600 mt-7">
              "Welcome to Wealth Partner – your trusted financial companion.
              Simplify expense tracking, manage investments, and achieve your
              financial goals effortlessly, all in one platform!"
            </p>
          ...
          <div class="col-span-2 hidden md:block md:col-span-1 lg:col-span-2 lg:pl-8">
            <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">
              Login to Wealth Partner
            </p>
