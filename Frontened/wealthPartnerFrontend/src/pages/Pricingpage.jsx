  ...
  return (
    <article id="pricingpage" className="">
      <p className="text-5xl font-bold landscape:text-4xl text-center mt-14 mb-8 capitalize">
        Choose the perfect subscription package for your needs.
      </p>
      <p className="text-gray-400 text-center mb-12 capitalize text-xl">
        No hidden charges <br /> Simple and transparent pricing
      </p>
      ...
      >
        <div className="flex flex-col items-center landscape:flex landscape:items-start">
          <p className="text-gray-400 mb-8 flex items-center">
            <span className=" mr-2 text-4xl font-bold primary-color flex items-center">
              <IndianRupee size={34} /> <span>69</span>
            </span>{" "}
